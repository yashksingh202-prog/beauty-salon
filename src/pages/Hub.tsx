...
const MENU_ITEMS = [
  { href: "/levels",       icon: LayoutGrid, label: "Play Levels",   color: "from-pink-400 to-rose-500",      desc: "1000 glamour levels!" },
...
export default function Hub() {
  ...
  const xpPerLevel = user.level * 1000;
  const xpPct = Math.min(100, (user.xp / xpPerLevel) * 1000);
    ...
    <div className="min-h-screen bg-background pb-20">
      ...
      <div className="pt-14 px-4 max-w-md mx-auto">
        ...
        <div className="mt-4 rounded-3xl p-5 text-white shadow-xl"
          ...
          <div className="grid grid-cols-2 gap-4 p-4" style={{ backgroundColor: "#1e0b2a", minHeight: "100vh" }}>
            {[
